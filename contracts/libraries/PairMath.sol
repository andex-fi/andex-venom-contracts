...
library LiquidityPoolMath {
    ...
    ) public returns (uint128 expected_fee) {
    ...
    function expectedExchange(
        ...
        uint16 fee_nominator,
        uint16 fee_denominator
    ) public returns (uint128 expected_amount, uint128 expected_fee) {
    ...
    function solveQuadraticEquationPQ(uint256 p, uint256 q) public returns (uint128) {
