...
const convertBigNumberValuesToStrings = obj =>
  Object.keys(obj).reduce((acc, key) => {
    acc[key] = obj[key] instanceof BigNumber ? obj[key].toString(10) : new BigNumber(obj[key]).toString(10);
    return acc;
  }, {});
 ...
 */
const convertToFixedPoint128 = value => new BigNumber(value).times(FIXED_POINT_128_MULTIPLIER);
 ...
 */
const convertFromFixedPoint128 = value => new BigNumber(value).div(FIXED_POINT_128_MULTIPLIER);
