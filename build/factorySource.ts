...
const tip3ToVenomAbi = {
  ...
  functions: [
    { name: "constructor", inputs: [], outputs: [] },
    { name: "onWvenomWallet", inputs: [{ name: "_wvenomWallet", type: "address" }], outputs: [] },
    {
      name: "buildExchangePayload",
      inputs: [
        { name: "pair", type: "address" },
    ...
    { name: "wvenomRoot", inputs: [], outputs: [{ name: "wvenomRoot", type: "address" }] },
    { name: "wvenomVault", inputs: [], outputs: [{ name: "wvenomVault", type: "address" }] },
    { name: "wvenomWallet", inputs: [], outputs: [{ name: "wvenomWallet", type: "address" }] },
  ],
  data: [
...
const venomWvenomToTip3Abi = {
  ...
  functions: [
    ...
    { name: "wvenomRoot", inputs: [], outputs: [{ name: "wvenomRoot", type: "address" }] },
    { name: "wvenomVault", inputs: [], outputs: [{ name: "wvenomVault", type: "address" }] },
    { name: "venomToTip3", inputs: [], outputs: [{ name: "venomToTip3", type: "address" }] },
    { name: "wvenomWallet", inputs: [], outputs: [{ name: "wvenomWallet", type: "address" }] },
  ],
  data: [
    { key: 1, name: "randomNonce_", type: "uint32" },
...
export const factorySource = {
  Account: accountAbi,
  CheckPubKey: checkPubKeyAbi,
  InternalOwner: internalOwnerAbi,
  Pair: pairAbi,
  Pausable: pausableAbi,
  Platform: platformAbi,
  RandomNonce: randomNonceAbi,
  Root: rootAbi,
  ...
  WvenomTunnel: wvenomTunnelAbi,
  WvenomVault: wvenomVaultAbi,
} as const;

export type FactorySource = typeof factorySource;
export type AccountAbi = typeof accountAbi;
export type CheckPubKeyAbi = typeof checkPubKeyAbi;
export type InternalOwnerAbi = typeof internalOwnerAbi;
export type PairAbi = typeof pairAbi;
export type PausableAbi = typeof pausableAbi;
export type PlatformAbi = typeof platformAbi;
export type RandomNonceAbi = typeof randomNonceAbi;
...
export type WvenomTunnelAbi = typeof wvenomTunnelAbi;
export type WvenomVaultAbi = typeof wvenomVaultAbi;
