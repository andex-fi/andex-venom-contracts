...
const selectorAbi = {
  ...
  functions: [
    { name: "constructor", inputs: [], outputs: [] },
    { name: "calculateAcceptTransferSelector", inputs: [], outputs: [{ name: "value0", type: "uint32" }] },
    { name: "calculateAcceptMintSelector", inputs: [], outputs: [{ name: "value0", type: "uint32" }] },
    { name: "calculateAcceptBurnSelector", inputs: [], outputs: [{ name: "value0", type: "uint32" }] },
    { name: "calculateTIP3TokenRootInterfaceID", inputs: [], outputs: [{ name: "value0", type: "uint32" }] },
    { name: "calculateTIP3TokenWalletInterfaceID", inputs: [], outputs: [{ name: "value0", type: "uint32" }] },
    { name: "calculateSIDInterfaceID", inputs: [], outputs: [{ name: "value0", type: "uint32" }] },
    { name: "calculateVersionedInterfaceID", inputs: [], outputs: [{ name: "value0", type: "uint32" }] },
    { name: "calculateTokenRootInterfaceID", inputs: [], outputs: [{ name: "value0", type: "uint32" }] },
    { name: "calculateTokenWalletInterfaceID", inputs: [], outputs: [{ name: "value0", type: "uint32" }] },
    { name: "calculateBurnableTokenWalletInterfaceID", inputs: [], outputs: [{ name: "value0", type: "uint32" }] },
    { name: "calculateBurnableByRootTokenRootInterfaceID", inputs: [], outputs: [{ name: "value0", type: "uint32" }] },
    {
      name: "calculateBurnableByRootTokenWalletInterfaceID",
      inputs: [],
      outputs: [{ name: "value0", type: "uint32" }],
    },
    { name: "calculateDestroyableInterfaceID", inputs: [], outputs: [{ name: "value0", type: "uint32" }] },
    { name: "calculateDisableableMintTokenRootInterfaceID", inputs: [], outputs: [{ name: "value0", type: "uint32" }] },
    { name: "calculateTransferableOwnershipInterfaceID", inputs: [], outputs: [{ name: "value0", type: "uint32" }] },
    { name: "calculateBurnPausableTokenRootInterfaceID", inputs: [], outputs: [{ name: "value0", type: "uint32" }] },
    { name: "calculateTokenWalletUpgradeableInterfaceID", inputs: [], outputs: [{ name: "value0", type: "uint32" }] },
    { name: "calculateTokenRootUpgradeableInterfaceID", inputs: [], outputs: [{ name: "value0", type: "uint32" }] },
  ],
...
const testRootTransferCallbackAbi = {
  ABIversion: 2,
  version: "2.2",
  header: ["time"],
  functions: [
    { name: "constructor", inputs: [], outputs: [] },
    { name: "setRoot", inputs: [{ name: "root", type: "address" }], outputs: [] },
    {
      name: "onTransferTokenRootOwnership",
      inputs: [
        { name: "oldOwner", type: "address" },
    ...
    { name: "_root", inputs: [], outputs: [{ name: "_root", type: "address" }] },
    {
      name: "_callback",
      inputs: [],
      outputs: [
...
const testTokenFactoryAbi = {
  ...
  functions: [
    ...
    { name: "changeDeployValue", inputs: [{ name: "deployValue", type: "uint128" }], outputs: [] },
    { name: "changeRootCode", inputs: [{ name: "rootCode", type: "cell" }], outputs: [] },
    { name: "changeWalletCode", inputs: [{ name: "walletCode", type: "cell" }], outputs: [] },
    { name: "changeRootUpgradeableCode", inputs: [{ name: "rootUpgradeableCode", type: "cell" }], outputs: [] },
    { name: "changeWalletUpgradeableCode", inputs: [{ name: "walletUpgradeableCode", type: "cell" }], outputs: [] },
    { name: "changePlatformCode", inputs: [{ name: "platformCode", type: "cell" }], outputs: [] },
    { name: "transferOwner", inputs: [{ name: "owner", type: "address" }], outputs: [] },
    { name: "acceptOwner", inputs: [], outputs: [] },
    { name: "upgrade", inputs: [{ name: "code", type: "cell" }], outputs: [] },
    { name: "_owner", inputs: [], outputs: [{ name: "_owner", type: "address" }] },
    { name: "_pendingOwner", inputs: [], outputs: [{ name: "_pendingOwner", type: "address" }] },
    { name: "_tokenNonce", inputs: [], outputs: [{ name: "_tokenNonce", type: "uint256" }] },
    { name: "_deployValue", inputs: [], outputs: [{ name: "_deployValue", type: "uint128" }] },
    { name: "_rootCode", inputs: [], outputs: [{ name: "_rootCode", type: "cell" }] },
    { name: "_walletCode", inputs: [], outputs: [{ name: "_walletCode", type: "cell" }] },
    { name: "_rootUpgradeableCode", inputs: [], outputs: [{ name: "_rootUpgradeableCode", type: "cell" }] },
    { name: "_walletUpgradeableCode", inputs: [], outputs: [{ name: "_walletUpgradeableCode", type: "cell" }] },
    { name: "_platformCode", inputs: [], outputs: [{ name: "_platformCode", type: "cell" }] },
  ],
  data: [{ key: 1, name: "_randomNonce", type: "uint256" }],
  events: [],
  fields: [
...
const testTokenRootUpgradeableV2Abi = {
  ABIversion: 2,
  version: "2.2",
  header: ["time"],
  functions: [
    ...
    { name: "onlyInV2", inputs: [{ name: "answerId", type: "uint32" }], outputs: [{ name: "value0", type: "string" }] },
    {
...
const testTokenWalletUpgradeableV2Abi = {
  ABIversion: 2,
  version: "2.2",
  header: ["time"],
  functions: [
...
const testWalletCallbackAbi = {
  ABIversion: 2,
  version: "2.2",
  header: ["time"],
  functions: [
    { name: "constructor", inputs: [{ name: "root", type: "address" }], outputs: [] },
    {
      name: "deployWallet",
      inputs: [
        { name: "walletOwner", type: "address" },
    ...
    { name: "onDeployWallet", inputs: [{ name: "wallet", type: "address" }], outputs: [] },
    {
      name: "onAcceptTokensTransfer",
      inputs: [
        { name: "tokenRoot", type: "address" },
    ...
    { name: "_randomNonce", inputs: [], outputs: [{ name: "_randomNonce", type: "uint256" }] },
    { name: "_root", inputs: [], outputs: [{ name: "_root", type: "address" }] },
    { name: "_wallet", inputs: [], outputs: [{ name: "_wallet", type: "address" }] },
    {
      name: "_transfer",
      inputs: [],
      outputs: [
    ...
    { name: "_bounced", inputs: [], outputs: [{ name: "_bounced", type: "bool" }] },
    { name: "_bouncedAmount", inputs: [], outputs: [{ name: "_bouncedAmount", type: "uint128" }] },
    { name: "_bouncedFrom", inputs: [], outputs: [{ name: "_bouncedFrom", type: "address" }] },
    { name: "_minted", inputs: [], outputs: [{ name: "_minted", type: "bool" }] },
    { name: "_mintedAmount", inputs: [], outputs: [{ name: "_mintedAmount", type: "uint128" }] },
    { name: "_mintedPayload", inputs: [], outputs: [{ name: "_mintedPayload", type: "cell" }] },
    { name: "_burned", inputs: [], outputs: [{ name: "_burned", type: "bool" }] },
    { name: "_burnedAmount", inputs: [], outputs: [{ name: "_burnedAmount", type: "uint128" }] },
    { name: "_burnedPayload", inputs: [], outputs: [{ name: "_burnedPayload", type: "cell" }] },
    { name: "_burnedBounced", inputs: [], outputs: [{ name: "_burnedBounced", type: "bool" }] },
  ],
  data: [{ key: 1, name: "_randomNonce", type: "uint256" }],
  events: [
    {
...
export const factorySource = {
  ...
  TestRootTransferCallback: testRootTransferCallbackAbi,
  TestTokenFactory: testTokenFactoryAbi,
  TestTokenRootUpgradeableV2: testTokenRootUpgradeableV2Abi,
  TestTokenWalletUpgradeableV2: testTokenWalletUpgradeableV2Abi,
  TestWalletCallback: testWalletCallbackAbi,
...
export type TestRootTransferCallbackAbi = typeof testRootTransferCallbackAbi;
export type TestTokenFactoryAbi = typeof testTokenFactoryAbi;
export type TestTokenRootUpgradeableV2Abi = typeof testTokenRootUpgradeableV2Abi;
export type TestTokenWalletUpgradeableV2Abi = typeof testTokenWalletUpgradeableV2Abi;
export type TestWalletCallbackAbi = typeof testWalletCallbackAbi;
